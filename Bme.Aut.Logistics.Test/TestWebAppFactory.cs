...
public class TestWebAppFactory : WebApplicationFactory<Program>
{
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        builder.ConfigureServices(services =>
        {
            ...
            var descriptor = services.SingleOrDefault(d => d.ServiceType == typeof(DbContextOptions<Dal.LogisticsDbContext>));
            if (descriptor != null)
                services.Remove(descriptor);
            services.AddDbContext<Dal.LogisticsDbContext>(options => options.UseSqlite(sqliteConnection));
            ...
            {
                var db = scope.ServiceProvider.GetRequiredService<Dal.LogisticsDbContext>();
    ...
    public void AddSeedEntities<T>(T[] entities)
    {
        ...
        {
            var db = serviceScope.ServiceProvider.GetRequiredService<Dal.LogisticsDbContext>();
